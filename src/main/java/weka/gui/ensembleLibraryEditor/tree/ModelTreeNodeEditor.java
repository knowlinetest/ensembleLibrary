...
public class ModelTreeNodeEditor
  ...
  /**
   * The last object a stop was fired on - mjh
   * This to avoid recursive/looping type calls w/ same object
   * and hopefully eliminate app locking up
   */
  private Object m_lastStopped = new Object();
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (evt.getSource().equals(m_lastStopped)) {	// mjh - avoid looping related hangs?
    	return;
    }
    else {
    	m_lastStopped = evt.getSource();
    }
